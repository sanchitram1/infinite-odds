...
/// @dev IMPORTANT: This contract uses an off-chain oracle to generate randomness, which is inherently vulnerable
/// @dev this is something quick and dirty, don't use it for anything serious, and intended for entertainment purposes only
/// @dev this should not be used for any serious applications or high-value transactions.
